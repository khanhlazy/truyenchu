@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex flex-col sm:flex-row items-center justify-between gap-4">
        <div class="flex-1 flex flex-col lg:flex-row items-center justify-between w-full gap-4">
            ...
            <div class="w-full overflow-x-auto pb-2 flex justify-center lg:justify-end">
